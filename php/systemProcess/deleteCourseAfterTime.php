<?php
/// Lorsqu'un profveux supprimer son cours, il n'est pas supprimer instantanément ( juste plus afficher)
/// cet page va supprimer définitivement au bout de 30jours
